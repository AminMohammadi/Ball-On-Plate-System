...
void Controller(float elapsed_time){
  ...
  if(elapsed_time < STABILIZATION_TIME){
    ...
    vx = K1*(zeta1x_desired - zeta1x) + K2*(zeta2x_desired - zeta2x) + K3*(zeta3x_desired - zeta3x) + K4*(zeta4x_desired - zeta4x);
  }
  ...
  if(elapsed_time < STABILIZATION_TIME){
    ...
    vy=K1*(zeta1y_desired - zeta1y) + K2*(zeta2y_desired - zeta2y) + K3*(zeta3y_desired - zeta3y) + K4*(zeta4y_desired - zeta4y);
  }
